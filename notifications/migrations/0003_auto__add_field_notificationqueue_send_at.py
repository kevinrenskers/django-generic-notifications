...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationQueue.send_at'
        db.add_column('notifications_notificationqueue', 'send_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationQueue.send_at'
        db.delete_column('notifications_notificationqueue', 'send_at')
